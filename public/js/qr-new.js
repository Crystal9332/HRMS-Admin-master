    ...
    $("form.form-qr").on("submit", function(e) {
            ...
            if ($(this)[0].checked) {
                    ...
                    .each(function(i, e) {
                        if (!$(this).val()) {
                            $(this)
                                ...
                                .find("div.help-block")
                                .html(
                                    '<ul role="alert"><li>This is required</li></ul>'
                                );
                            validate = false;
                        } else {
                            cnt++;
                ...
                if (cnt == 2) {
                    ...
                    data[
                        ...
                        $(this)
                            .closest(".time-container")
                            .find('input.form-control[type="date"]')
                            .val() +
                        " " +
                        $(this)
                            .closest(".time-container")
                            .find('input.form-control[type="time"]')
                            .val() +
                        ":00";
                    // data.push(res);
                }
        ...
        if (isEmpty(data)) {
            $("div.validate-error").html(
                '<div>Please check either "Start" or "End" at least</div>'
            );
            return;
        }
