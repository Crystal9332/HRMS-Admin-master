...
@section('page-title')
QrCode <i class="breadcrumb-symbol"></i> Edit
@endsection
    ...
    <div class="card">
      <div class="card-body">
        <form class="form-qr" action="javascript:;" novalidate>
          @csrf
          <input type="hidden" value="{{ $qr->id }}" id="code-id"/>
          <div class="form-body">
            <div class="row">
              <div class="col-md-8">
              ...
              <div class="col-md-6">
                ...
                <div>
                  ...
                  <div class="d-flex justify-content-center align-content-center">
                    ...
                    <div class="hidden qr-code">{!! $qr->code !!}</div>
                  </div>
                </div>
              </div>
            </div>
...
<script src="{{ asset('js/qr-edit.js') }}"></script>
@endsection